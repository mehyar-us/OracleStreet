...
export const RBAC_ROUTE_POLICY = [
  ...
  { surface: 'campaigns', permission: 'manage_campaigns', routes: ['POST /api/campaigns', 'POST /api/campaigns/approve-dry-run', 'POST /api/campaigns/schedule-dry-run', 'POST /api/campaigns/enqueue-dry-run', 'GET /api/campaigns/calendar', 'GET /api/campaigns/calendar/allocation', 'GET /api/campaigns/calendar/drilldown', 'GET /api/campaigns/calendar/reschedule-plan', 'GET /api/campaigns/calendar/capacity-forecast', 'GET /api/campaigns/calendar/launch-readiness', 'GET /api/campaigns/calendar/operator-actions', 'GET /api/campaigns/calendar/warmup-board', 'GET /api/campaigns/calendar/cap-review'] },
  ...
  { surface: 'sending_readiness', permission: 'review_sending_readiness', routes: ['GET /api/email/sending-readiness', 'GET /api/email/mta-operations', 'GET /api/email/provider/readiness-drilldown', 'GET /api/email/controlled-live-test/readiness', 'POST /api/email/controlled-live-test/plan', 'GET /api/email/controlled-live-test/seed-observation', 'GET /api/email/controlled-live-test/proof-packet', 'GET /api/email/controlled-live-test/final-approval-packet', 'GET /api/email/controlled-live-test/operator-actions', 'GET /api/send-queue/readiness'] }
];
