...
export const RBAC_ROUTE_POLICY = [
  ...
  { surface: 'contact_metadata', permission: 'view_contacts_metadata', routes: ['GET /api/contacts', 'GET /api/contacts/browser', 'GET /api/contacts/detail', 'GET /api/contacts/source-quality', 'GET /api/contacts/source-hygiene-plan', 'GET /api/contacts/audience-readiness', 'GET /api/list-hygiene/plan', 'GET /api/contacts/dedupe-merge-plan'] },
  { surface: 'campaigns', permission: 'manage_campaigns', routes: ['POST /api/campaigns', 'POST /api/campaigns/approve-dry-run', 'POST /api/campaigns/schedule-dry-run', 'POST /api/campaigns/enqueue-dry-run', 'GET /api/campaigns/calendar', 'GET /api/campaigns/calendar/allocation', 'GET /api/campaigns/calendar/drilldown', 'GET /api/campaigns/calendar/reschedule-plan', 'GET /api/campaigns/calendar/capacity-forecast'] },
  ...
  { surface: 'data_sources', permission: 'manage_data_sources', routes: ['POST /api/data-sources', 'POST /api/data-source-query/execute', 'POST /api/data-source-schema/discover', 'POST /api/data-source-import/execute', 'POST /api/data-source-import-schedules', 'GET /api/data-source-import-schedules/worker-plan', 'GET /api/data-source-import-schedules/runbook', 'GET /api/data-source-import-schedules/audit'] },
