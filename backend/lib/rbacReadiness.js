...
export const RBAC_ROUTE_POLICY = [
  ...
  { surface: 'sending_readiness', permission: 'review_sending_readiness', routes: ['GET /api/email/sending-readiness', 'GET /api/email/mta-operations', 'GET /api/email/provider/readiness-drilldown', 'GET /api/email/controlled-live-test/readiness', 'POST /api/email/controlled-live-test/plan', 'GET /api/email/controlled-live-test/seed-observation', 'GET /api/email/controlled-live-test/proof-packet', 'GET /api/email/controlled-live-test/operator-actions', 'GET /api/send-queue/readiness'] }
];
