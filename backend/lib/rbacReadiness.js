...
export const RBAC_ROUTE_POLICY = [
  ...
  { surface: 'data_sources', permission: 'manage_data_sources', routes: ['POST /api/data-sources', 'POST /api/data-source-query/execute', 'POST /api/data-source-schema/discover', 'POST /api/data-source-import/execute', 'POST /api/data-source-import-schedules', 'POST /api/data-source-import-schedules/status', 'GET /api/data-source-import-schedules/worker-plan', 'GET /api/data-source-import-schedules/runbook', 'GET /api/data-source-import-schedules/audit'] },
