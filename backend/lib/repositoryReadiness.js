...
const MODULES = [
  ...
  { module: 'data_source_import_schedules', targetTable: 'data_source_import_schedules', runtimeMode: 'in-memory', priority: 12, blocker: 'wire_remote_import_schedule_repository_to_postgresql_driver' },
  { module: 'controlled_live_test_proof_audits', targetTable: 'controlled_live_test_proof_audits', runtimeMode: 'in-memory', priority: 13, blocker: 'wire_controlled_proof_audit_repository_to_postgresql_driver' }
];
