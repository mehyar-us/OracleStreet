...
const MODULES = [
  ...
  { module: 'segments', targetTable: 'segments,segment_snapshots', runtimeMode: 'saved-filter-snapshot', priority: 4, blocker: 'wire_segment_snapshot_repository_to_postgresql_driver' },
  { module: 'campaigns', targetTable: 'campaigns', runtimeMode: 'in-memory', priority: 5, blocker: 'wire_campaign_repository_to_postgresql_driver' },
  { module: 'send_queue', targetTable: 'send_jobs', runtimeMode: 'in-memory', priority: 6, blocker: 'wire_send_queue_repository_to_postgresql_driver' },
  { module: 'email_events', targetTable: 'email_events', runtimeMode: 'in-memory', priority: 7, blocker: 'wire_email_event_repository_to_postgresql_driver' },
  { module: 'warmup_policies', targetTable: 'warmup_policies', runtimeMode: 'in-memory', priority: 8, blocker: 'enable_policy_repository_after_pg_driver' },
  { module: 'reputation_policies', targetTable: 'reputation_policies', runtimeMode: 'in-memory', priority: 9, blocker: 'enable_policy_repository_after_pg_driver' },
  { module: 'audit_log', targetTable: 'audit_log', runtimeMode: 'in-memory', priority: 10, blocker: 'wire_audit_repository_to_postgresql_driver' },
  { module: 'users', targetTable: 'users', runtimeMode: 'bootstrap-env-plus-memory-session', priority: 11, blocker: 'wire_user_repository_to_postgresql_driver' },
  { module: 'user_invite_password_workflow', targetTable: 'users', runtimeMode: 'manual-code-invite-reset', priority: 12, blocker: 'enable_user_invite_password_workflow_repository' },
