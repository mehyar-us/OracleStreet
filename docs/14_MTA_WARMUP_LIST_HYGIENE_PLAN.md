...
1. PostgreSQL persistence for remote import schedules and controlled proof audits.
2. Multi-user/RBAC enforcement hardening beyond the safe invite-plan baseline.
