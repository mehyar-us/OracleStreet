...
1. Continued MTA/reputation depth: seed/live-proof inbox observation remains manual/out-of-band until approved.
2. Remote import scheduler execution remains gated/no automatic pulls until a future explicit approval slice.
3. Campaign calendar UX polish and reporting drilldowns after warm-up cap enforcement.
