...
1. PostgreSQL-persist remote import schedules and controlled proof audits.
2. RBAC enforcement hardening.
3. Affiliate/campaign metadata depth.
4. Audit timeline depth.
