...
1. RBAC enforcement hardening.
2. Affiliate/campaign metadata depth.
3. Audit timeline depth.
4. Remote source persistence for source registry/encrypted secret metadata.
