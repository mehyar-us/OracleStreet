...
2. Data-source sync-run persistence and operator replay controls.
3. Continued MTA/reputation operational depth.
4. Owner/admin role-edit hardening for multi-user operations.
