...
- Campaign calendar API/UI showing scheduled dry-runs against sender-domain warm-up caps, remaining capacity, over-cap days, read-only multi-domain allocation, and read-only day drilldowns with campaign breakdowns/recommendations.
