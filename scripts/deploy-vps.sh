...
for repo in contacts suppressions templates segments campaigns send_queue email_events users user_invite_password_workflow admin_sessions audit_log warmup_policies reputation_policies data_sources data_source_encrypted_secrets data_source_sync_runs data_source_import_schedules controlled_live_test_proof_audits; do
